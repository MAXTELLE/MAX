...
local serpent = dofile('./inc/serpent.lua')
...
if msg.text and msg.text:match("^(.*)$") then
  if redis:get(max.."makal:bots:set"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
    sendMsg(msg.chat_id_, msg.id_, '\nتم حفظ السؤال بنجاح')
    redis:set(max.."makal:bots:set"..msg.sender_user_id_..":"..msg.chat_id_,"true1uu")
    redis:sadd(max.."makal:bots", msg.text)
    return false
  end
end
if msg.text == redis:get(max.."makal:bots:qus"..msg.chat_id_) then
  local timemkall = redis:ttl(max.."mkal:setex:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
  local timemkal = (60 - timemkall)
  if tonumber(timemkal) == 1 then
  sendMsg(msg.chat_id_, msg.id_,'  استمر ي وحش ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 2 then
  sendMsg(msg.chat_id_, msg.id_,'  اكيد محد ينافسك ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 3 then
  sendMsg(msg.chat_id_, msg.id_,'  اتوقع محد ينافسك ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 4 then
  sendMsg(msg.chat_id_, msg.id_,'  مركب تيربو !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 5 then
  sendMsg(msg.chat_id_, msg.id_, '  صح عليك !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 6 then
  sendMsg(msg.chat_id_, msg.id_,'   صحيح !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 7 then
  sendMsg(msg.chat_id_, msg.id_,'   شد حيلك ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 8 then
  sendMsg(msg.chat_id_, msg.id_, '  عندك اسرع ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 9 then
  sendMsg(msg.chat_id_, msg.id_,'   يجي ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 10 then
  sendMsg(msg.chat_id_, msg.id_,'   كفو ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 11 then
  sendMsg(msg.chat_id_, msg.id_,'   ماش !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 12 then
  sendMsg(msg.chat_id_, msg.id_,'   مستوى مستوى !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 13 then
  sendMsg(msg.chat_id_, msg.id_,'   تدرب ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 14 then
  sendMsg(msg.chat_id_, msg.id_,'   مدري وش اقول ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 15 then
  sendMsg(msg.chat_id_, msg.id_,'   بطه ! \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 16 then
  sendMsg(msg.chat_id_, msg.id_,'   ي بطوط !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 17 then
  sendMsg(msg.chat_id_, msg.id_,'   مافي اسرع  !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 18 then
  sendMsg(msg.chat_id_, msg.id_,'   بكير  !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 19 then
  sendMsg(msg.chat_id_, msg.id_,'   وش هذا !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 20 then
  sendMsg(msg.chat_id_, msg.id_,'   الله يعينك !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 21 then
  sendMsg(msg.chat_id_, msg.id_,'   كيبوردك يعلق ههههه  !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 22 then
  sendMsg(msg.chat_id_, msg.id_,'   يبي لك تدريب  !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 23 then
  sendMsg(msg.chat_id_, msg.id_,'   انت اخر واحد رسلت وش ذا !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 24 then
  sendMsg(msg.chat_id_, msg.id_,'   ههههه بطى !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 25 then
  sendMsg(msg.chat_id_, msg.id_,'   ابك وش العلم !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 26 then
  sendMsg(msg.chat_id_, msg.id_,'  اخر مرا تلعب !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 27 then
  sendMsg(msg.chat_id_, msg.id_,'   ي بطي !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 28 then
  sendMsg(msg.chat_id_, msg.id_,'   ليه انت بطى يخوي !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 29 then
  sendMsg(msg.chat_id_, msg.id_,'   تدبر زين بس  !  \n عدد الثواني {'..timemkal..'}')
  elseif tonumber(timemkal) == 30 then
  sendMsg(msg.chat_id_, msg.id_,'  مستوى بس !  \n عدد الثواني {'..timemkal..'}')
  end
  redis:del(max.."makal:bots:qus"..msg.sender_user_id_..":"..msg.chat_id_)
  redis:del(max.."mkal:setex:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
  end
  
  if redis:get(max.."CHENG:ID:bot"..msg.chat_id_..""..msg.sender_user_id_) then 
	if msg.text == 'الغاء' then 
		sendMsg(msg.chat_id_, msg.id_,"܁تم الغاء تعيين الايدي") 
	  redis:del(max.."CHENG:ID:bot"..msg.chat_id_..""..msg.sender_user_id_) 
	  return false  
	end 
	redis:del(max.."CHENG:ID:bot"..msg.chat_id_..""..msg.sender_user_id_) 
	local CHENGER_ID =  msg.text:match("(.*)")  
	redis:set(max.."KLISH:ID:bot"..msg.chat_id_,CHENGER_ID)
	sendMsg(msg.chat_id_, msg.id_,'܁تم تعيين الايدي بنجاح')    
end
if msg.photo and redis:get(max.."Limit:Photos:"..msg.chat_id_..""..msg.sender_user_id_) then
redis:sadd(max.."Limit:Photos:",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
sendMsg(msg.chat_id_, msg.id_,'ok kara')    
end
...
function tdcli_update_callback(data)
  ...
  if Text and Text:match('^RB:(.*):(.*):(.*)$') then
	local G = Text:split(':')
	local list = redis:smembers(max.."Limit:Photos:")
	if tonumber(G[4])  == tonumber(data.sender_user_id_) then
		if G[2] == 'Next' then
			local keyboard = {}
			if #list == 0 then
				keyboard.inline_keyboard = {}
				--answerCallbackQuery(data.id_,'لايوجد صوره', true)
				return false
			elseif tonumber(G[3]) - 1 == 0 then
				num = #list - 1
				keyboard.inline_keyboard = {
					{
					{text = 'التالي', callback_data="RB:Next:2:"..data.sender_user_id_}},{
					{text = 'اغلاق', callback_data="RB:Close:"..num2..":"..data.sender_user_id_}}}
			elseif tonumber(G[3]) < #list then
				num1 = tonumber(G[3]) + 1
				num2 = tonumber(G[3]) - 1
				keyboard.inline_keyboard = {
					{
					{text = 'السابق', callback_data="RB:Next:"..num2..":"..data.sender_user_id_},
					{text = 'التالي', callback_data="RB:Next:"..num1..":"..data.sender_user_id_}},{
					{text = 'اغلاق', callback_data="RB:Close:"..num2..":"..data.sender_user_id_}}}
				elseif tonumber(G[3]) >= #list then
					num2 = tonumber(G[3]) - 1
					keyboard.inline_keyboard = {
						{
						{text = 'السابق', callback_data="RB:Next:"..num2..":"..data.sender_user_id_},
						{text = 'الرئيسيه', callback_data="RB:Next:1:"..data.sender_user_id_}},{
						{text = 'اغلاق', callback_data="RB:Close:"..num2..":"..data.sender_user_id_}}}
			end
			Del_msg(data.chat_id_,data.message_id_)
			sendPhoto2(data.chat_id_, list[tonumber(G[3])], 0, '', 'md',keyboard)
		elseif G[2] == 'Close' then
			Del_msg(data.chat_id_,data.message_id_)
			--answerCallbackQuery(data.id_,'تم اغلاق الافتارات', true)
		end
	else
		answerCallbackQuery(data.id_,'- لاتغضط يولد', true)
	end
  elseif Text and Text:match('^EIKOei:(.*):(.*)$') then
    local G = Text:split(':')
...
┄─┅═ـ═┅─┄
  ...
  {
  {text = '⓸', callback_data="/help4@"..data.sender_user_id_},{text = 'اوامر التسليه', callback_data="/help5@"..data.sender_user_id_},
  },
  {
  {text = 'الالعاب', callback_data="/help6@"..data.sender_user_id_},
  },
  {
...
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
  ...
  elseif Text and Text:match('/EIKOeiYes@(.*)') then
	  local users = Text:match('/EIKOeiYes@(.*)')
	  if tonumber(users) == tonumber(data.sender_user_id_) then
	  local Teext = 'أجابتك صحيحه'
	  redis:incrby(max..':User_Points:'..data.chat_id_..data.sender_user_id_,1)  
	  editMessageText(Chat_id,msg_idd,Teext,false,'md')
	  end
	  elseif Text and Text:match('/EIKOeiNo@(.*)') then
	  local users = Text:match('/EIKOeiNo@(.*)')
	  if tonumber(users) == tonumber(data.sender_user_id_) then
	  local Teext = 'أجابتك غير صحيحه'
	  editMessageText(Chat_id,msg_idd,Teext,false,'md')
	  end
...
🔰│م4 » آوآمر آلخدمه 
  ...
  {
  {text = 'اغلاق', callback_data="/BLACK@"..data.sender_user_id_},
  },
  }
  ...
  elseif Text and Text:match('/BLACK@(.*)') then
  local users = Text:match('/BLACK@(.*)')
  if tonumber(users) == tonumber(data.sender_user_id_) then
  local Teext = [[
  تم اغلاق اوامر البوت
  ]]
  keyboard = {} 
  keyboard.inline_keyboard = {{{text="المطور",url="https://telegram.me/JllllB?startgroup=new"},},}
