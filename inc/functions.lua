...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(max..':MALK_BOT:'..ChatID,UserID) then
var = ' المـــــــــالك💥' 
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(max..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(max..':MALK_BOT:'..msg.chat_id_,data.id_)
end)
...
elseif redis:sismember(max..':KARA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"✹*┃*لا يمكنك تقييد المنشي الاساسي\n❧")   
elseif redis:sismember(max..':MONSHA_BOT:'..ChatID,UserID) then 
...
elseif redis:sismember(max..':KARA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"✹*┃*لا يمكنك حظر المنشي الاساسي\n❧") 
elseif redis:sismember(max..':MONSHA_BOT:'..ChatID,UserID) then 
...
elseif redis:sismember(max..':KARA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"✹*┃*لا يمكنك كتم المنشي الاساسي\n❧") 
elseif redis:sismember(max..':MONSHA_BOT:'..ChatID,UserID) then 
...
elseif redis:sismember(max..':KARA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"✹*┃*لا يمكنك طرد المنشي الاساسي\n❧") 
elseif redis:sismember(max..':MONSHA_BOT:'..ChatID,UserID) then 
